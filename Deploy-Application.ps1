...
Try {
	...
	[string]$appName = 'App Inventor'
	[string]$appVersion = '2.3.0'
	[string]$appArch = 'x32'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '10/10/2019'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'aistarter' -CheckDiskSpace -PersistPrompt
		...
		Execute-Process -Path "$dirFiles\MIT_App_Inventor_Tools_2.3.0_win_setup.exe" -Parameters '/S' -WindowStyle 'Hidden'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'aistarter' -CloseAppsCountdown 60
		...
		Execute-Process -Path "$envProgramFilesX86\AppInventor\uninstall.exe" -Parameters '/S' -WindowStyle 'Hidden'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA2mQoTSrMv3KmJ
# cuQAjMtvwK/uQbAyW7JcVHXY5G5XDqCCFFwwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgkWY3psgk
# acTuC/2trWfPwJ8rGZt3Z5dlY6kLB5qarlcwDQYJKoZIhvcNAQEBBQAEggEAmYK4
# ze6tCLfMYL30gy4oFPCpk4tu6z8UCYYYelWJxULWSDSU2WRnRQriD7ZQaf+QX3SQ
# O72/23SjM8cpZwWAqNmdfsYpG9be+pfAH3iBTOt4IUhRsuppBDlSIlO3YFUrmd/E
# iCXomGJEOO+KtnB8hCePR40KsVMm+QuhCImaQeyarxiBnX+5jVbzvh5MSljJtUbt
# UTzpZQ1XKJLVQrVyE4cR3Qfp2lx3A9G9iN8zkPSTCJTeP0TGZPeZyvKHRM8OMxbd
# aB+giLsVacUhM5JUhpOawc44jfCopAgDhzOoaoPOb0Gb1oKFESup6JCUDn/gxSK3
# TJdYZCXSgQp99bKTk6GCAqIwggKeBgkqhkiG9w0BCQYxggKPMIICiwIBATBoMFIx
...
# CSqGSIb3DQEJBTEPFw0xOTEwMTAxOTM5NDVaMCMGCSqGSIb3DQEJBDEWBBSdHa/D
# B/lcvZr01jdwlgHRWVxZhDCBnQYLKoZIhvcNAQkQAgwxgY0wgYowgYcwgYQEFGO4
...
# ggEAOlZTXHrHjCrtZnqqevS1ixwGplDfqGn/97ONpTpEYbE9FSI15JNoTyFBnF+X
# rNhUciGWoaH/UlL4X93JhMGElQIJeY1VDs2lEUYyhimEMTdNP4PJ0QsQKvELGdrJ
# 48b1YUeVNWvLswUnQnjhPYohM5dIwxCxhO07QAj2euqxs9WVc5JPS7voISRoqDDg
# KFLvFxAAszcVndO2A34gFxSkZObwBL2NZ12wvej1vgaMOfWasP30EI8+FYZhEIkT
# lr3PPfVE503Izs8pPxNrNA4SIswU+qegaUsYloSdN6PwzP2H4JIgVrkAUAqTBGTV
# QQeR5t/2dG9G/LGEy4yLPx8QdQ==
